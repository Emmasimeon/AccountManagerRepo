                    ...
                    <div class="app-main__inner">
                        ...
                        {{-- Include the message notification bar here --}}
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>TOTAL (<b>{{strtoupper($Payment_Name[0]['income_category'])}}</b>) RECEIVED FOR ({{$TERM[0]['term']}})
                                    </div>
                                </div>
                                </div>
                        </div>            
                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Total <b>{{strtoupper($Payment_Name[0]['income_category'])}}</b> Receipts for <b><i>{{$TERM[0]['term']}}</i></b></h5>
