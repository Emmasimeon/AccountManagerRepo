                        ...
                        {{-- Include the message notification bar here --}}
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Other Payment Transaction Details
                                    </div>
                                </div>
                                </div>
                        </div>            
                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Enter Transaction Reference No:</h5>
                                        <form method="POST" action="/Other/Payment/Transactions" class="">
                                            {{ csrf_field()}}
                                            
                                            <div class="form-row">
                                                <div class="col-md-8">
                                                    <div class="position-relative form-group"><label for="Class" class="">Transaction Reference No:</label>
                                                       <input class="form-control" type="text" name="Trx_id" id="Trx_id" placeholder="Enter 7-digit Ref No:">
                                                    </div>
                                                </div>
                                            </div>
