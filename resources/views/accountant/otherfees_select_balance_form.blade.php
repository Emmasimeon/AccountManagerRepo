                    ...
                    <div class="app-main__inner">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Select Previous Transaction Payment Details</h5>
                                        <form method="GET" action="/Other/Fees/Balance/{{$Student[0]['SAN_id']}}" class="">
                                                {{ csrf_field()}}
                                            ...
                                            <div class="form-row">
                                                <div class="position-relative form-group col-md-12"><label for="Payment" class=""><b>Payment:</b></label>
