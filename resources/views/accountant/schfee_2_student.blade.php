                        ...
                        {{-- Include the message notification bar here --}}
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Initiate School Fees Payment
                                    </div>
                                </div>
                            </div>
                        </div>            
                                        ...
                                        <table class="mb-0 table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                @if (Auth::user()->user_category == 'Accountant')
                                                    <th>Student Payment History:</th>
                                                @else
                                                    <th>New Payment:</th>
                                                    <th>Pay Oustanding:</th>
                                            ...
                                            <tbody>
                                                        ...
                                                        @foreach ($Student as $Stu )
                                                            <tr>
                                                                ...
                                                                @if (Auth::user()->user_category == 'Accountant')
                                                                    <td><a class="btn btn-success btn-sm" href="/SchFee_Payment_History/{{$Stu->SAN_id}}">View History   <i class="fa fa-list"></i></a></td>
                                                                @else 
                                                                    <td><a class="btn btn-info btn-sm" href="/School_Fees/{{$Stu->SAN_id}}">Pay   <i class="fa fa-money-bill-wave"></i></a></td>
                                                                <td><a class="btn btn-warning btn-sm" href="/Balance/{{$Stu->SAN_id}}">Outstanding <i class="fa fa-money-bill"></i></a></td>
                                                                <td><a class="btn btn-success btn-sm" href="/SchFee_Payment_History/{{$Stu->SAN_id}}">View History   <i class="fa fa-list"></i></a></td>
                                                                @endif
                                                             </tr>
                                                        @endforeach
