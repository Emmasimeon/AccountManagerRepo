                        ...
                        {{-- Include the message notification bar here --}}
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>POST TERM SCHOOL FEES ANALYSIS FOR ({{$TERM[0]['term']}})</br>
                                    <small>SCHOOL FEES PAID FOR <u><b>{{$TERM[0]['term']}}</b></u> IN A SUCCEDDING TERM</small>
                                    </div>
                                </div>
                                </div>
                        </div>            
                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">ANALYSIS OF POST-TERM SCHOOL FEES TRANSACTION FOR <b><i>{{$TERM[0]['term']}}</i></b></h5>
