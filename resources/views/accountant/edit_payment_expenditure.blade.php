                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Edit Payment/Expenditures</h5>
                                        <form method="POST" action="/Update/Expenditure/{{$Payments[0]['id']}}" class="">
                                            {{ csrf_field()}}

                                            <div class="form-row">
                                                <div class="col-md-6 pr-4">
                                                    <div class="position-relative form-group"><label for="Expenditure" class="">Payment/Expenditures</label>
                                                        <input name="Expenditure" id="Expenditure" value="{{$Payments[0]['expenditures']}}" type="text" class="form-control">
                                                    </div>
                                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Payments/Expenditures Details</h5>
