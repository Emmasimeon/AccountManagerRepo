                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Cash Banking Report for { <i>{{$Start_Date}}</i> } to { <i>{{$End_Date}}</i> }</h5>
                                        ...
                                        <?php $number = 1; ?>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">TELLER NO:</th>
