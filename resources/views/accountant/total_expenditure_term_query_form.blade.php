                        ...
                        {{-- Include the message notification bar here --}}
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>TOTAL EXPENDITURES ON A PARTICULAR PAYMENT PER TERM
                                    </div>
                                </div>
                                </div>
                        </div>            
                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Select Payment/Expenditure and Term</h5>
                                        <form method="POST" action="/Expenditures/Total/Transactions" class="">
                                            {{ csrf_field()}}
                                            
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group"><label for="Payment" class="">Payment/Expenditure</label>
                                                        <select name="Payment" id="Payment" class="form-control">
                                                            <option></option>
                                                        @foreach ($Payments as $Pay )
                                                            <option value="{{$Pay->id}}">{{$Pay->expenditures}}</option>
                                                        @endforeach
                                                        </select>
                                                    </div>
                                                </div>
