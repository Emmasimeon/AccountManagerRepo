                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Add a Student</h5>
                                        <form method="POST" action="/Save_Student" class="">
                                                {{ csrf_field()}}

                                            <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="position-relative form-group"><label for="Stu_Reg_No" class="">Student Reg No</label><input name="Stu_Reg_No" id="Stu_Reg_No" placeholder="i.e BSS/19/232" type="text" class="form-control" maxlength="10" required></div>
                                                    </div>
                                                    <div class="col-md-6">
                                            ...
                                            <div class="form-row">
                                                    <div class="col-md-4">
                                                        <div class="position-relative form-group"><label for="Surname" class="">Surname</label><input name="Surname" id="Surname" placeholder="Bello" type="text" class="form-control" required></div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="position-relative form-group"><label for="FirstName" class="">First Name</label><input name="FirstName" id="FirstName" placeholder="Uche" type="text" class="form-control" required></div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="position-relative form-group"><label for="MiddleName" class="">Other Name</label><input name="MiddleName" id="MiddleName" placeholder="Obi" type="text" class="form-control"></div>
                                                    </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="position-relative form-group"><label for="Stu_Class" class="">Class</label>
                                                        <select name="Stu_Class" id="Stu_Class" class="form-control" required>
                                                            <option></option>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="position-relative form-group"><label for="PaymentFeeStatus" class="">Student Payment Status</label>
                                                        <select name="PaymentFeeStatus" id="PaymentFeeStatus" class="form-control" required>
                                                            <option></option>
