                        ...
                        {{-- Include the message notification bar here --}}
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>SCHOOL FEES RECEIVED ANALYSIS FOR ({{$SESSION[0]['sessions']}}) - ACADEMIC SESSION
                                    </div>
                                </div>
                                </div>
                        </div>            
                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">ANALYSIS OF SCHOOL FEES TRANSACTION FOR <b><i>{{$SESSION[0]['sessions']}} - ACADEMIC SESSION</i></b></h5>
