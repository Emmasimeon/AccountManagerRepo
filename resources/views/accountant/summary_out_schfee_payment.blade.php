                    ...
                    <div class="app-main__inner">
                        ...
                        {{-- Include the message notification bar here --}}
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Outstanding School Fees Payment Summary
                                    </div>
                                </div>
                                </div>
                        </div>    
                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Outstanding School Fee Payment Summary</h5>
                                        

                                            <div class="form-row">
                                                    <div class="col-md-4">
                                                        <div class="position-relative form-group"><label for="Trx_Ref" class=""><b>Previous Transaction Reference:</b></label>
                                                            <input value="{{$TRX[0]['Ref_Trx_id']}}" type="text" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="position-relative form-group"><label for="Trx_Ref" class=""></br>
                                                        <a type="button" class="mt-2 btn btn-primary" target="_blank" href="/Transaction/{{$TRX[0]['Ref_Trx_id']}}">Query Previous Transaction</a>
                                                            <a></a>
                                                        </div>
                                                    </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">School Fee Payment Mode:</h5>
                                            ...
                                            @if (session('confirmed'))
                                                <a type="button" class="mt-2 btn btn-primary disabled" href="/Outstanding/Receipt/{{$Student[0]['SAN_id']}}/{{$TRX[0]['Trx_id']}}">STEP 1 -> Confirm Transaction</a>
                                            ...
                                            @else
                                                <a type="button" class="mt-2 btn btn-primary" href="/Outstanding/Receipt/{{$Student[0]['SAN_id']}}/{{$TRX[0]['Trx_id']}}">STEP 1 -> Confirm Transaction</a>
                                                <a type="button" class="mt-2 btn btn-danger float-right" href="/dashboard" data-toggle="modal" data-target="#EndTransactionModal">STEP 2 -> Finalize Transaction</a>
                                            @endif
