                                    ...
                                    <div class="card-body"><h5 class="card-title">Payment</h5>
                                            <div class="form-row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <a type="button" class="mt-2 btn btn-primary" target="_blank" href="/Other/Transaction/{{$TRX[0]['Ref_Trx_id']}}">Query Previous Transaction</a>
                                                            <a></a>
                                                        </div>
                                                    </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Payment Mode:</h5>
                                            ...
                                            @if (session('confirmed'))
                                                <a type="button" class="mt-2 btn btn-primary disabled" href="/Other/Receipt/Balance/{{$Student[0]['SAN_id']}}/{{$TRX[0]['Trx_id']}}">STEP 1 -> Confirm Transaction</a>
                                            ...
                                            @else
                                                <a type="button" class="mt-2 btn btn-primary" href="/Other/Receipt/Balance/{{$Student[0]['SAN_id']}}/{{$TRX[0]['Trx_id']}}">STEP 1 -> Confirm Transaction</a>
                                                <a type="button" class="mt-2 btn btn-danger float-right" href="/dashboard" data-toggle="modal" data-target="#EndTransactionModal">STEP 2 -> Finalize Transaction</a>
                                            @endif
