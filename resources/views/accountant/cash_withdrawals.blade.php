...
@section('content')
    <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        {{-- Include the message notification bar here --}}
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>CASH WITHDRAWAL - (WITHDRAWAL OF MONEY FROM BANK) 
                                    </div>
                                </div>
                                </div>
                        </div>            
                        ...
                        <form method="POST" action="/Cash/Withdrawal/Process" class="">
                        {{ csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <div class="main-card mb-2 card">
                                    <div class="card-body"><h5 class="card-title">CASH RECEIVER DETAILS</h5>
                                        ...
                                        <div class="card-body"><h5 class="card-title">BANK DETAILS</h5>
                                            <div class="position-relative form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="position-relative form-group"><label for="Cheque" class="">CHEQUE NO:</label>
                                                            <input type="text" name="Cheque" placeholder="i.e 15140306" class="form-control" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                <h5 class="card-title">TRANSACTION DETAILS:</h5>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3">
                                            <div class="position-relative form-group"><label for="date" class="">TRANSACTION DATE:</label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="position-relative form-group"><label for="Authority" class="">AUTHORIZED BY:</label>
                                                <input type="text" name="Authority" placeholder="i.e Director 1 (Josh Omeiza)" class="form-control" required>
                                            </div>
                                        </div>
