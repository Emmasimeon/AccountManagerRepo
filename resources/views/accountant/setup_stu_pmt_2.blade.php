                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">List of all currently active students in {{$Stu_Class[0]['stu_class_name']}}</h5>
                                            ...
                                            <tbody>
                                                        ...
                                                        @foreach ($Student as $Stu )
                                                            <tr>
                                                                ...
                                                                <td><a class="btn btn-info btn-sm" href="/SchoolFeesSetUp/{{$Stu->SAN_id}}">Setup   <i class="fa fa-sliders-h"></i></a></td>
                                                             </tr>
                                                        @endforeach
                                                @else
